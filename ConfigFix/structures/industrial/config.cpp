...
class CfgVehicles
{
	...
	{
		scope=2;
		model="DZ\structures\Industrial\Coalplant\CoalPlant_Conveyor.p3d"; // Changed "CoalPlant_Conveyors.p3d" to "CoalPlant_Conveyor.p3d" //
	};
	class Static_CoalPlant_LoadingHouse: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Coalplant\CoalPlant_LoadingHouse.p3d"; // Changed \Lighting\ to \Coalplant\ //
	};
	...
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_CowshedA.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_CowshedB: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_CowshedB.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_CowshedC: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_CowshedC.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_Hopper: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_Hopper.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_StrawStack: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_StrawStack.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_WaterTower: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_WaterTower.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Barn_WaterTower_Small: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Farms\Farm_WaterTower_Small.p3d"; // Changed "Barn_" to "Farm_" //
	};
	class Static_Boathouse_PierL: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\industrial\harbour\boathouse_pierl.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Boathouse_PierR: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\industrial\harbour\boathouse_Pierr.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Boathouse_PierT: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\industrial\harbour\boathouse_piert.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_CornerIn: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_CornerIn.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_CornerOut: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_CornerOut.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_End.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_R: HouseNoDestruct // Changed _L to _R //
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_R.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_R10: HouseNoDestruct // Changed _L10 to _R10 //
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_R10.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_R30: HouseNoDestruct // Changed _L30 to _R30 //
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_R30.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_L: HouseNoDestruct // Added Classname for L Variant //
	{
		scope=2;
		model="DZ\structures\industrial\harbour\pier_concrete1_l.p3d"; 
	};
	class Static_Pier_Concrete1_L10: HouseNoDestruct // Added Classname for L Variant //
	{
		scope=2;
		model="DZ\structures\industrial\harbour\pier_concrete1_l10.p3d"; 
	};
	class Static_Pier_Concrete1_L30: HouseNoDestruct // Added Classname for L Variant //
	{
		scope=2;
	...
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_TBig.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete1_TSmall: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete1_TSmall.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete2: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete2.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete2_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete2_End.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete3_1: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete3_1.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete3_2: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete3_2.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete3_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete3_End.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Concrete3_Fuel: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Concrete3_Fuel.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Crane_Rails: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Crane_Rails.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Crane_Rails_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Crane_Rails_End.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Tube_Big: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Tube_Big.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Tube_Small: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Tube_Small.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Wooden1: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Wooden1.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	class Static_Pier_Wooden1_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\harbour\Pier_Wooden1_End.p3d"; // Changed \Garages\ to \Harbour\ //
	};
	...
	class Static_Mine_Conveyer1_Build: HouseNoDestruct // Changed "Static_Mine_Conveyer1_Build" to "Static_Mine_Conveyer2_Build" //
	{
		scope=2;
		model="DZ\structures\Industrial\Mines\Mine_Conveyer2_Build.p3d"; // Changed "Mine_Conveyer1_Build.p3d" to "Mine_Conveyer2_Build.p3d" //
	};
	...
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_1aoh.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_1Bo_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_1Bo.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_1Mo_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2mo.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_1Moh_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2moh.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_1C_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_1C.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_1D_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_1D.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_2A_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2A.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_2B_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2B.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_2C_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2C.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_2D_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2D.p3d"; // Added \Containers\ to Model Dir //
	};
	class Static_Container_2E_DE: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Industrial\Containers\Container_2E.p3d"; // Added \Containers\ to Model Dir //
	};
