...
class CfgVehicles
{
	...
	{
		scope=2;
		model="DZ\structures\specific\Airfields\airfield_lamp.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_Edge: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_Edge.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_Navig: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_Navig.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_PAPI1: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_PAPI1.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_PAPI2: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_PAPI2.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_PAPI3: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_PAPI3.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_PAPI4: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_PAPI4.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_Reflector: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_Reflector.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_Control: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_Control.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	class Static_Airfield_Light_Hangar: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Airfields\Airfield_Light_Hangar.p3d"; // Replaced \Airfields\ with \Airfields\ //
	};
	...
	class Static_Hotel_Damaged_Airplane_Wing: HouseNoDestruct
	{
		scope=2;
	...
	class Static_Skilift_Rope_Middle: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Skilift\Skilift_Rope_Middle.p3d";
	};
	class Static_Skilift_Rope_Start: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Skilift\Skilift_Rope_Start.p3d";
	};
	class Static_Skilift_Tower_End: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Skilift\Skilift_Tower_End.p3d";
	};
	class Static_Skilift_Tower_Middle: HouseNoDestruct
	{
		scope=2;
	...
	class Static_Monument_Soldiers: HouseNoDestruct
	{
		scope=2;
		model="DZ\structures\Specific\Statues\Monument_Soldiers.p3d";
	};
	class Static_Monument_Wall: HouseNoDestruct
	{
		scope=2;
